...
//                LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT));
    ...
    private void ensureScrollAnimator() {
        if (mScrollAnimator == null) {
            ...
            mScrollAnimator.setInterpolator(com.android.support.design.widget.AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        void animateIndicatorToPosition(final int position, int duration) {
            ...
            if (startLeft != targetLeft || startRight != targetRight) {
                ...
                animator.setInterpolator(com.android.support.design.widget.AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
                ...
                animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    ...
                    public void onAnimationUpdate(ValueAnimator animator) {
                        ...
                        setIndicatorPosition(
                                com.android.support.design.widget.AnimationUtils.lerp(startLeft, targetLeft, fraction),
                                com.android.support.design.widget.AnimationUtils.lerp(startRight, targetRight, fraction));
                    }
                });
...
//            }
            ...
            if (mSelectedIndicatorPaint != null && mIndicatorLeft >= 0 && mSelectedIndicatorHeight > 0 && mSelectedIndicatorWidth != 0
                ...
                Log.d("", "draw: -----------------IndicatorTop = " + a);
                Log.d("", "draw: -----------------Indicatorbottom = " +  b);
            ...
            Log.d("", "draw: -----------------bottomLineTop = " + c);
            Log.d("", "draw: -----------------bottomLineBottom = " +  d);
