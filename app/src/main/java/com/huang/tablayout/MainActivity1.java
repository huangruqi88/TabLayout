 ...
 * @author PC
 */
public class MainActivity1 extends AppCompatActivity implements OnTabSelectListener {

    private SlidingTabLayout mTabLayout;
    private ViewPager mViewPager;
    private String[] mTitles;
    private String mNoGenerate;
...
//        stringArray = getResources().getStringArray(R.array.album_title);

        initView(); // 初始化控件
        initViewPager(); // 初始化ViewPager
//
//        mNoGenerate = getResources().getString(R.string.album_tab_no_generate);
//        mGenerated = getResources().getString(R.string.album_tab_generated);
//        Log.d("", "onCreate: ----------------stringArray=" + stringArray);
    }
    ...
    private void initViewPager() {
        ...
        mNoGenerate = getResources().getString(R.string.tab1);
        mGenerated = getResources().getString(R.string.tab2);
        mTitles = new String[]{mNoGenerate, mGenerated};
        // 创建ViewPager适配器
